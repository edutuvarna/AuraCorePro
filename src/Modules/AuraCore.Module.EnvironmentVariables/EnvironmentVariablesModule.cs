...
namespace AuraCore.Module.EnvironmentVariables;

public class EnvironmentVariablesModule : IOptimizationModule
{
    ...
    {
        // TODO: Implement scan for Environment Variables
    ...
    {
        // TODO: Implement optimization for Environment Variables
...
public static class EnvironmentVariablesRegistration
{
    public static void AddEnvironmentVariablesModule(IServiceCollection sc)
        => sc.AddSingleton<IOptimizationModule, EnvironmentVariablesModule>();
}

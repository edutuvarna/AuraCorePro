...
/// <summary>
/// Phase 4.3.5: LinuxAppInstallerView uses Layout X "accordion + live search"
...
/// Mirrors KernelCleanerViewTests / DockerCleanerViewTests structure.
/// </summary>
public class LinuxAppInstallerViewTests
{
    [AvaloniaFact]
    public void Ctor_DoesNotThrow()
    {
        var v = new LinuxAppInstallerView();
        Assert.NotNull(v);
    }
    ...
    public void ModuleHeader_HasExpectedTitle()
    {
        ...
        Assert.Equal("Linux App Installer", header!.Title);
    }

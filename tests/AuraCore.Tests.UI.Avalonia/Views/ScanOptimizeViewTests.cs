...
/// <summary>
/// Phase 4.0: ScanOptimizeView migrated to ModuleHeader + GlassCard shell.
/// ScanOptimizeView has a parameterless ctor (module = null!) that guards
/// null early, so no App.Services seeding is required.
/// </summary>
public class ScanOptimizeViewTests
{
    [AvaloniaFact]
    public void Ctor_DoesNotThrow()
    {
        var v = new ScanOptimizeView();
        Assert.NotNull(v);
    }

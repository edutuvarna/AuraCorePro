...
/// <summary>
/// Phase 4.0: IsoBuilderView migrated to ModuleHeader + GlassCard shell.
/// IsoBuilderView is a full-screen wizard; ModuleHeader is placed as a hidden
/// top-row element that satisfies the shell contract while preserving the
/// sidebar + step-panels + terminal-overlay layout.
/// </summary>
public class IsoBuilderViewTests
{

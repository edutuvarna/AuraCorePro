...
namespace AuraCore.API.Infrastructure.Migrations
{
    ...
    [Migration("20260428071357_AddAuditRetentionSettingsAndIndex")]
    partial class AddAuditRetentionSettingsAndIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AuraCore.API.Domain.Entities.AppConfig", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTimeOffset(new DateTime(2026, 4, 28, 7, 13, 56, 638, DateTimeKind.Unspecified).AddTicks(7402), new TimeSpan(0, 0, 0, 0, 0)),
                            MaintenanceMessage = "",
            ...
            modelBuilder.Entity("AuraCore.API.Domain.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Key = "audit_retention.retentionDays",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 4, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "365"
                        },
                        new
                        {
                            Key = "audit_retention.lastRunAt",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 4, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = ""
                        },
                        new
                        {
                            Key = "audit_retention.lastRunDeletedRows",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 4, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "0"
                        });
                });

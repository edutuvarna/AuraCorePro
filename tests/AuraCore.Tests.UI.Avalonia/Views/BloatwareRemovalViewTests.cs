...
/// <summary>
/// Phase 4.0: BloatwareRemovalView migrated to ModuleHeader + StatRow + GlassCard shell.
/// BloatwareRemovalView.ctor resolves IOptimizationModule via App.Services,
/// so we seed a minimal ServiceProvider before constructing.
/// </summary>
public class BloatwareRemovalViewTests
{
    ...
    public void Ctor_DoesNotThrow()
    {
        ...
        var v = new BloatwareRemovalView();
        Assert.NotNull(v);
    }

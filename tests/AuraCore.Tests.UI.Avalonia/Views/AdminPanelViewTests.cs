...
/// <summary>
/// Phase 4.0: AdminPanelView migrated to ModuleHeader + 2x GlassCard shell.
/// AdminPanelView.ctor does not call App.Services, so no ServiceProvider seeding needed.
/// </summary>
public class AdminPanelViewTests
{
    [AvaloniaFact]
    public void Ctor_DoesNotThrow()
    {
        var v = new AdminPanelView();
        Assert.NotNull(v);
    }

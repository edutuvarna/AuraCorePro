...
/// <summary>
/// Phase 4.0: RegistryOptimizerView migrated to ModuleHeader + GlassCard shell.
/// RegistryOptimizerView.ctor resolves IOptimizationModule via App.Services,
/// so we seed a minimal ServiceProvider before constructing.
/// </summary>
public class RegistryOptimizerViewTests
{
    ...
    public void Ctor_DoesNotThrow()
    {
        ...
        var v = new RegistryOptimizerView();
        Assert.NotNull(v);
    }

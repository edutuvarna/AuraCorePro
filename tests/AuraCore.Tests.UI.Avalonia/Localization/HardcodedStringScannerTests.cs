...
public class HardcodedStringScannerTests
{
    ...
    private static readonly HashSet<string> GrandfatheredFiles = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "src/UI/AuraCore.UI.Avalonia/Views/LoginWindow.axaml",
        "src/UI/AuraCore.UI.Avalonia/Views/MainWindow.axaml",
        "src/UI/AuraCore.UI.Avalonia/Views/Pages/AdminPanelView.axaml",
        "src/UI/AuraCore.UI.Avalonia/Views/Pages/AI/ChatSection.axaml",
        "src/UI/AuraCore.UI.Avalonia/Views/Pages/AI/InsightsSection.axaml",
        "src/UI/AuraCore.UI.Avalonia/Views/Pages/AI/RecommendationsSection.axaml",
        "src/UI/AuraCore.UI.Avalonia/Views/Pages/AI/ScheduleSection.axaml",
        ...
        "src/UI/AuraCore.UI.Avalonia/Views/Pages/DashboardView.axaml",

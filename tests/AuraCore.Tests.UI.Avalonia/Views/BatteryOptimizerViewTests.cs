...
/// <summary>
/// Phase 4.0: BatteryOptimizerView migrated to ModuleHeader + GlassCard shell.
/// BatteryOptimizerView.ctor resolves IOptimizationModule via App.Services,
/// so we seed a minimal ServiceProvider before constructing.
/// </summary>
public class BatteryOptimizerViewTests
{
    ...
    public void Ctor_DoesNotThrow()
    {
        ...
        var v = new BatteryOptimizerView();
        Assert.NotNull(v);
    }

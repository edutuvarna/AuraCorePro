...
/// <summary>Non-generic synchronous ICommand helper.</summary>
...
/// <summary>
/// Async ICommand that fires-and-forgets a Task. CanExecute re-queried on
/// <see cref="RaiseCanExecuteChanged"/>. Exceptions in the task propagate to
/// the TaskScheduler (the VM catches its own exceptions internally; this is a safety net).
/// </summary>

...
/// <summary>
/// Phase 4.0: TimeMachineManagerView migrated to ModuleHeader + StatRow + GlassCard shell.
/// </summary>
public class TimeMachineManagerViewTests
{
    [AvaloniaFact]
    public void Ctor_DoesNotThrow()
    {
        var v = new TimeMachineManagerView();
        Assert.NotNull(v);
    }
